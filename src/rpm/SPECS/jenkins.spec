...
Requires:   ss-develenv-user >= 33 httpd java-21-openjdk mod_proxy_html daemonize initscripts polkit policycoreutils
Vendor:     softwaresano
...
%config /etc/httpd/conf.d/develenv-jenkins.conf
